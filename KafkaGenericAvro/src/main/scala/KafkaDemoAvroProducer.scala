...
//        println(s"Producer sending data ${currentTime.toString}")
//        producer.send(new ProducerRecord[String, Array[Byte]](topic, currentTime.toString.getBytes))


          val user = User(2, "eva mendes", Some("eva@ishot.com"))
